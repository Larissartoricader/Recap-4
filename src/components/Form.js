...
// export default function Form({ onAddTheme, defaultValue }) {
//   const [name, setName]= useState("");
//   const [primary, setPrimary] = useState("");
//   const [secondary, setSecondary] = useState("");
//   const [surface, setSurface] = useState("");
//   const [surfaceon, setSurface] = useState("");

//   useEffect(() => {
//     if (defaultValue) {
//       setName(defaultValue.name || "");
//       setPrimary(defaultValue.primary || "");
//       setSecondary(defaultValue.secondary || "");
//       setSurface(defaultValue || "");
//       setSurfaceon(defaultValue || "");
//     }
//   }, [defaultValue]);
